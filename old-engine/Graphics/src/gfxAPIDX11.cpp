...
namespace GFX
{
                       ...
                       float screenNear )
    {
        ...
        deviceContext_->RSSetState(rasterState_[RS_SOLID]);
        ...
        D3DXMatrixIdentity(&modelToWorld_);
    ...
    void API::BeginScene( const Color& color )
    {
        ...
        deviceContext_->ClearRenderTargetView(renderTargetView_, colorComponent);
    ...
    void API::RenderWireframe( unsigned int type )
    {
        deviceContext_->RSSetState(rasterState_[type]);
    }

    ID3D11Device* API::Device() const
    {
        return device_;
    }

    ID3D11DeviceContext* API::DeviceContext() const
    {
