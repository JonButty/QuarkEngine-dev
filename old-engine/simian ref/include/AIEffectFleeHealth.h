 ...
 */
/******************************************************************************/
#ifndef DESCENSION_AIEFFECTFLEEHEALTH_H_
#define DESCENSION_AIEFFECTFLEEHEALTH_H_
...
namespace Descension
{
	...
	class AIEffectFleeHealth : public AIEffectBase
	{
    private:
        enum FleeState
        {
	...
	private:
		...
		static Simian::FactoryPlant<AIEffectBase, AIEffectFleeHealth> factoryPlant_;
    private:
        void onAwake_();
