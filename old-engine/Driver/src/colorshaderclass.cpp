...
bool ColorShaderClass::Initialize(ID3D11Device* device, HWND hwnd)
{
	...
	result = InitializeShader(device, hwnd, L"data\\shaders\\vertex\\default.vs", L"data\\shaders\\pixel\\default.ps");
	if(!result)
	{
		return false;
	}
...
bool ColorShaderClass::InitializeShader(ID3D11Device* device, HWND hwnd, WCHAR* vsFilename, WCHAR* psFilename)
{
	...
	result = device->CreateInputLayout(GFX::VertexLayout, GFX::VertexLayoutElementCount, vertexShaderBuffer->GetBufferPointer(), 
